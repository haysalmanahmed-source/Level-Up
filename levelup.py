...
Status: {status}
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY HEXOZENTA 
"""
            else:
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]HEXOZENTA    
[FFD700]✨ DM FOR GUILD BOT TELEGRAM USERNAME @hexozenta 🔥 
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> HEXOZENTA ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "HEXOZENTA", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To HEXOZENTA's BOT"
...
async def MaiiiinE():
    Uid , Pw = '4395743995','70F672942647616AE502FD3A16003E227D3204395E5257F108CE2322E9542088'
    ...
    os.system('clear')
    print("Initializing HEXOZENTA Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    os.system('clear')
    print(render('HEXOZENTAs', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 HEXOZENTA BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using HEXOZENTA")
    sys.exit(0)
